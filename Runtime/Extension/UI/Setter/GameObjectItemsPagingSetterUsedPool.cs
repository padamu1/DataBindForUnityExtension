...
namespace SimulFactory.DataBindForUnityExtension.UI.Setter
{
    ...
    /// </summary>
    [AddComponentMenu("Data Bind/Foundation/Setters/[DB] Game Object Items Paging Setter Used Pool")]
    public class GameObjectItemsPagingSetterUsedPool : ItemsSetter
    {
        private class Item
        {
        ...
        public DataBinding loadIndexDownEndAction;
        ...
        #region Pooling
        private Queue<ContextHolder> objectPool= new Queue<ContextHolder>();

        private void ReturnToPool(ContextHolder obj)
        {
            obj.Context = null;
            objectPool.Enqueue(obj);
        }

        private ContextHolder GetFromPool()
        {
            ...
            GameObject o = Instantiate(Prefab, this.Target, false);
        ...
        /// </summary>
        protected IEnumerable<ContextHolder> ItemGameObjects
        {
            get { return this.items.Select(item => item.ContextHolder); }
        }
        ...
        private void DestroyAll()
        {
            ...
            {
                this.OnItemDestroyed(item.Context, item.ContextHolder);
            }
        ...
        private bool LoadIndexDown()
        {
            ...
            {
                if (loadIndexDownEndAction.Value is Action loadEndAction)
                {
        ...
        {
            ContextHolder item = GetFromPool();

            this.items.Add(new Item { ContextHolder = item, Context = itemContext });
            ...
            if (itemContext != null)
            {
                ...
                item.SetContext(itemContext, path + DataBindSettings.PathSeparator + itemIndex);
            }
        ...
        protected virtual void OnItemDestroyed(object itemContext, ContextHolder itemObject)
        {
            // Destroy item.
